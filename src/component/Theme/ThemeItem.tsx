...
const ThemeItem = ({
  ...
  return (
    <div {...props} data-theme={dataTheme} className={classes}>
      <div className="bg-orange-100 text-base-content w-full cursor-pointer font-sans">
        <div className="grid grid-cols-5 grid-rows-3">
          <div className="bg-orange-200 col-start-1 row-span-2 row-start-1" />
          <div className="bg-orange-300 col-start-1 row-start-3" />
          <div className="bg-orange-100 col-span-4 col-start-2 row-span-3 row-start-1 flex flex-col gap-1 p-2">
